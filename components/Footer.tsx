            ...
            <div className="pt-4">
              ...
              <div className="flex">
                <input
                  ...
                  className="px-3 py-2 bg-zinc-800 text-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary w-full"
                />
                <button className="bg-primary hover:bg-primary px-4 py-2 rounded-r-md transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
